...
export default function UserReports() {
  ...
  const contactModule = modules?.find(
    ({ moduleName }) => moduleName === "Contacts"
  );
  const propertiesModule = modules?.find(
    ({ moduleName }) => moduleName === "Properties"
  );
  const tasksModule = modules?.find(({ moduleName }) => moduleName === "Tasks");
  const reportModule = modules?.find(
    ({ moduleName }) => moduleName === "Reporting and Analytics"
  );
  const emailModule = modules?.find(
    ({ moduleName }) => moduleName === "Emails"
  );
                ...
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  ...
                  >
                    ...
                    <Text fontWeight={600} color={"#43882f"}>
                      <CountUpComponent
                        targetNumber={findLeadStatus("active")}
                      />
                    </Text>
                  </Box>
                </GridItem>
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  ...
                  >
                    ...
                    <Text fontWeight={600} color={"#a37f08"}>
                      <CountUpComponent
                        targetNumber={findLeadStatus("pending")}
                      />
                    </Text>
                  </Box>
                </GridItem>
                ...
                <GridItem colSpan={{ base: 12, md: 6 }}>
                  ...
                  >
                    ...
                    <Text fontWeight={600} color={"#d6401d"}>
                      <CountUpComponent targetNumber={findLeadStatus("sold")} />
                    </Text>
                  </Box>
                </GridItem>
              </Grid>
